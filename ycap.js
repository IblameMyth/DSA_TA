...
console.log("Databases:", db.adminCommand({ listDatabases: 1 }));
console.log("Collections in ecommerce:", db.getCollectionNames());
...
console.log("Server Status:", db.serverStatus());
